...
[Mostre também as diferenças. Uma genealogia deve dizer onde a comparação deixa de funcionar.]

## [Título editorial para a transformação produzida]

[Compare o que cada artefato reduz, aumenta, desloca ou torna visível. Conecte conceitos e variáveis. Explore como pequenas reduções de custo podem criar novos hábitos ou expectativas.]

[Analise relações de poder quando existirem: quem controla acesso, ordem, memória, atenção, risco ou critérios de pertencimento?]

## [Título editorial para a hipótese que sobra]

[Formule a hipótese mais forte da genealogia como hipótese do projeto, não como fato histórico. Termine com uma pergunta que possa orientar novos estudos.]
...
[Inclua referências próprias apenas quando a genealogia fizer afirmações externas que não estejam apenas sintetizando estudos já ligados. Use notas junto das afirmações correspondentes.]
