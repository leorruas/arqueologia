...
## [2026-09-22]
- **Ritmo editorial e voz do agente**: Revisão da governança de escrita para reduzir fragmentação típica de texto gerado por LLM. Novos artigos e revisões devem avançar por movimentos argumentativos amplos, com parágrafos desenvolvidos e seções que normalmente reúnem vários parágrafos; microseções, headings para cada observação e sequências de parágrafos de uma ou duas frases deixam de ser a cadência padrão. Também foi formalizada a restrição ao molde retórico `não é X, é Y` e variantes (`não se trata de X, mas de Y`, `menos X e mais Y`, `não apenas X, mas Y`) quando usados apenas para produzir efeito. Contrastes conceituais materiais continuam permitidos. Propagação realizada em [[AGENTS|AGENTS.md]], [[me|me.md]], [[Guia de escrita|Guia de escrita]], [[Instrucoes de Arqueologia|Instruções de arqueologia]] e templates de artefato, genealogia, percurso, tipo de design, conceito e variável. A regra permanece sem teste automático por exigir julgamento semântico.

## [2026-09-11]
- **Genealogia e Foucault**: Explicitação de [[autores/Michel Foucault|Michel Foucault]] como referência metodológica para a camada `04 genealogias/`, sobretudo a partir de *Nietzsche, a genealogia e a história* (1971). O método passa a distinguir genealogia histórica inspirada por emergência, contingência, disputa e descontinuidade de parentescos funcionais, semióticos, comportamentais, institucionais ou comparativos. [[01 conceitos/Genealogia de Futuros|Genealogia de Futuros]] passa a registrar explicitamente essa inspiração, preservando sua procedência como hipótese do projeto e sem atribuir o conceito a Foucault. Atualização de [[Instrucoes de Arqueologia|Instruções de arqueologia]], [[me|me.md]], [[templates/template-genealogia|template de genealogia]], [[00 índices/Sobre o projeto|Sobre o projeto]] e do perfil de Foucault.
- **Promessa e Genealogia de Futuros**: Registro da propagação iniciada no estudo de futuros. Criação de [[01 conceitos/Promessa|Promessa]] como hipótese do projeto para distinguir a função de um artefato da transformação de mundo que ele torna imaginável. Revisão de [[01 conceitos/Genealogia de Futuros|Genealogia de Futuros]] para incorporar a cadeia `problema → promessa → artefato → adoção → hábito → expectativa → norma → infraestrutura → novo problema → nova promessa`, a distinção entre futuro prometido e futuro produzido e a hipótese de que o sucesso de uma solução pode gerar o problema de seus descendentes. Propagação para [[01 conceitos/Continuidade de Acesso|Continuidade de acesso]], [[02 variaveis/Expectativa de Disponibilidade|Expectativa de disponibilidade]], [[Instrucoes de Arqueologia|Instruções de arqueologia]], [[templates/template-artefato|template de artefato]] e [[00 índices/Indice de Conceitos|Índice de conceitos]]. A ficha arqueológica passa a investigar promessa, futuro prometido, futuro produzido, normalização da promessa, futuro tornado mais provável, descendentes possíveis e novo problema produzido pelo sucesso.

## [2026-09-10]
- **Novos estudos — Favorito / bookmark e Badge de notificação**: Criação de [[03 artefatos/Favorito Bookmark|Favorito / bookmark]] para investigar a preservação de referências e caminhos de retorno sem posse do conteúdo, e de [[03 artefatos/Badge de notificacao|Badge de notificação]] para investigar a externalização persistente de estados pendentes. Propagação para [[00 tipos de design/Design de Interface|Design de interface]], [[01 conceitos/Continuidade de Acesso|Continuidade de acesso]], [[01 conceitos/Memoria Distribuida|Memória distribuída]], [[01 conceitos/Autonomia da Atencao|Autonomia da atenção]], [[04 genealogias/Permanencia e Memoria Externa|Permanência e memória externa]], [[04 genealogias/Acesso e Disponibilidade|Acesso e disponibilidade]], [[04 genealogias/Atencao e Recompensa|Atenção e recompensa]], [[05 percursos/Como o Design Aprendeu a Guardar|Como o design aprendeu a guardar]] e [[05 percursos/Da Parede ao Feed|Da parede ao feed]]. As duas pistas foram promovidas no backlog de `Pistas de pesquisa.md`.
- **Auditoria de propagação e consistência**: Auditoria do vault após a formalização do protocolo de propagação. Criação de `scripts/audit-network.mjs` para detectar ausência em índices, notas órfãs, drift entre fichas e tipos de design, reciprocidade estrutural e títulos duplicados; integração ao workflow automático; expansão da auditoria editorial para a ficha arqueológica de 26 campos. Sincronização dos índices de artefatos, autores e empresas; atualização das notas de Design de Interface, Produto, Serviços, Gráfico, Tipografia e IA; propagação de relações nas genealogias de permanência, limiares, coordenação, reversibilidade e compressão do esforço. Correção semântica dos perfis de Barry Schwartz e Robert Adler, com nova regra de propagação semântica em [[me|me.md]]. Migração automática de fichas legadas, remoção da duplicata `Espaço entre palavras.md`, integração de `Da parede ao interlocutor` à home e limpeza da inbox já processada.
- **Tipos de design e percursos narrativos**: Formalização em `Guia de escrita`, `Instrucoes de Arqueologia.md`, `me.md` e templates de que notas em `00 tipos de design/` são ensaios disciplinares sobre classes de problemas e notas em `05 percursos/` são argumentos de leitura, não verbetes enciclopédicos ou playlists de links. Criação de `template-percurso.md`, revisão do `template-tipo-design.md`, expansão da auditoria editorial e refatoração dos seis tipos de design e dos cinco percursos para o novo modelo.
