...
Uma garrafa de água, uma fila, um agendamento, um cartão de embarque, um bookmark, um arquivo digital e o infinite scroll parecem pertencer a mundos diferentes. Mas todos alteram uma mesma distância: o intervalo entre querer alguma coisa e conseguir acessá-la.
...
O [[03 artefatos/Favorito Bookmark|favorito / bookmark]] reduz outro intervalo sem transportar nem necessariamente copiar o recurso. Ele preserva uma referência de retorno para que a pessoa não precise memorizar o endereço ou reconstruir o percurso de navegação. A disponibilidade futura passa a depender de dois elementos separados: a permanência do caminho guardado e a permanência do destino externo.
...
O bookmark introduz uma terceira estratégia. Ele não transporta o recurso nem necessariamente uma credencial capaz de acessá-lo: transporta ou sincroniza **uma referência**. Isso basta para reduzir o custo de voltar quando o destino continua disponível.

Portabilidade, portanto, é uma das maneiras de produzir continuidade. Preservar referências é outra. Acesso e disponibilidade respondem uma pergunta mais ampla: “quanto custa chegar ao recurso quando eu preciso dele?”.

Essa distinção evita tratar mobilidade, ubiquidade, referência e disponibilidade como sinônimos.

## Quando disponibilidade muda comportamento

A disponibilidade parece uma qualidade neutra até percebermos que ela pode alterar a frequência do comportamento. Uma garrafa ao alcance da mão permite beber sem procurar uma fonte. Um feed sem fim permite continuar consumindo conteúdo sem formular uma nova escolha. Uma agenda reduz a necessidade de disputar atendimento no momento em que ele ocorre. Um bookmark permite converter rapidamente uma descoberta presente numa intenção futura de retorno.

Essa é a conexão com [[01 conceitos/Tecnologia de Acesso|tecnologia de acesso]] e [[01 conceitos/Continuidade de Acesso|continuidade de acesso]]. O design pode transformar uma relação episódica em coordenada, portátil, referenciável ou quase contínua. Ao fazer isso, reduz [[02 variaveis/Custo de Busca|custo de busca]] e [[02 variaveis/Custo Transacional|custo transacional]], mas também pode aumentar a [[02 variaveis/Expectativa de Disponibilidade|expectativa de disponibilidade]]. Depois que algo se torna fácil de acessar, sua ausência começa a parecer uma falha.
...
“Conveniência” costuma funcionar como uma palavra ampla demais. Uma hipótese mais precisa seria tratá-la como um conjunto de operações sobre o intervalo entre intenção e acesso. Um projeto pode diminuir distância física, eliminar espera, reduzir busca, antecipar coordenação, preservar um caminho ou remover uma decisão intermediária.
...
| **Hipótese de parentesco** | Artefatos muito diferentes podem transformar acesso episódico em acesso coordenado, portátil, referenciável ou quase contínuo |
| **Natureza das relações** | Funcional, comportamental, institucional e comparativa; não implica descendência histórica |
| **Artefatos principais** | [[03 artefatos/Garrafa de Agua|Garrafa de água]], [[03 artefatos/Fila|Fila]], [[03 artefatos/Agendamento|Agendamento]], [[03 artefatos/Cartao de Embarque|Cartão de embarque]], [[03 artefatos/Archive|Archive]], [[03 artefatos/Favorito Bookmark|Favorito / bookmark]], [[03 artefatos/Infinite Scroll|Infinite scroll]] |
| **Comportamento recorrente** | Procurar, esperar, deslocar-se, coordenar-se, marcar caminhos e continuar acessando recursos |
| **O que o design redistribui** | Espera, deslocamento, busca, coordenação, memória de caminhos, decisão e disponibilidade |
| **Relação de poder** | Quem define a arquitetura de acesso pode definir prioridade, ritmo, critérios de entrada e condições sob as quais um caminho continuará válido |
...
| **Cuidado histórico** | Os artefatos são aproximados por mecanismo de acesso, não por uma linhagem histórica direta; portabilidade e preservação de referências são estratégias dentro do problema mais amplo de disponibilidade |
| **Hipótese em aberto** | Conveniência pode ser descrita com mais precisão como redução ou redistribuição do intervalo entre intenção e acesso; resta investigar quais intervalos não deveriam ser eliminados e quando preservar um caminho produz apenas a ilusão de continuidade |
