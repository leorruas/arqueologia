...
Use esta lente quando a pergunta for disciplinar: **que tipo de problema este campo aprendeu a reconhecer como projetável?** As notas funcionam como ensaios sobre a formação de um olhar, não como definições enciclopédicas de profissões.
...
Use esta lente para atravessar disciplinas e perguntar **por que artefatos diferentes podem ser parentes**. O parentesco pode ser histórico, funcional, semiótico, comportamental ou comparativo; não implica automaticamente descendência direta.
...
Use esta lente quando a pergunta exigir uma sequência: **o que acontece com uma ideia quando lemos certos artefatos numa ordem deliberada?** Percursos são argumentos de leitura, não sumários de artigos.
