...
- [[Archive|Archive]] — Promove a autonomia da atenção ao permitir que o usuário recupere dados proativamente por meio de buscas, em vez de se submeter à fadiga da categorização de pastas.
...
- **Definição**: Teoria que mede o grau de arbítrio do usuário sobre quando e onde colocar seu foco atencional.
- **Artefatos chave explicados**: [[Archive|Archive]], [[Infinite Scroll|Infinite Scroll]], [[Post-it|Post-it]]
