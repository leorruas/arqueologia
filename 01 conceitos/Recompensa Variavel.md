...
- [[Pull to Refresh|Pull to Refresh]] — Funciona como uma alavanca de cassino: ao arrastar a lista para baixo, o usuário aguarda ansiosamente a fração de segundo para ver quais informações imprevisíveis surgirão.
...
- **Definição**: Mecanismo de reforço de comportamento sustentado pela incerteza e imprevisibilidade dos retornos de uma ação.
- **Artefatos chave explicados**: [[Pull to Refresh|Pull to Refresh]], [[Botao Like|Botão Like]], [[Infinite Scroll|Infinite Scroll]]
