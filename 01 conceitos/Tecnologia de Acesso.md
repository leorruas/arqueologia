...
- [[03 artefatos/Controle Remoto|Controle Remoto]] — Não produz programas de televisão; apenas reduz a zero o esforço físico e o tempo exigido para sintonizá-los.
- [[03 artefatos/Fila|Fila]] — Não produz o atendimento ou o recurso escasso; apenas organiza e distribui o acesso sequencial ao balcão com legitimidade e justiça procedimental.
...
- **Definição**: Princípio que estuda artefatos e serviços focados em reorganizar a acessibilidade espacial e temporal a recursos existentes, mudando o comportamento do usuário através da variação de custos de acesso.
- **Artefatos chave explicados**: [[03 artefatos/Controle Remoto|Controle Remoto]], [[03 artefatos/Fila|Fila]], [[03 artefatos/Archive|Archive]]
