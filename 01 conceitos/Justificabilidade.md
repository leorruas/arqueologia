...
- [[03 artefatos/Value Proposition Ad Lib|Value Proposition Ad Lib]] — Obriga a equipe de design a converter ideias implícitas em uma hipótese verbal estruturada e justificável de benefício ao usuário antes do desenvolvimento da solução.
...
- **Definição**: Princípio que determina que decisões de projeto e alocações de recursos coletivos devem vir acompanhadas de uma justificativa lógica e baseada em evidências, de modo a tornarem-se compreensíveis e contestáveis.
- **Artefatos chave explicados**: [[03 artefatos/Value Proposition Ad Lib|Value Proposition Ad Lib]], [[03 artefatos/Justificativa de Valor Público|Justificativa de Valor Público]], [[03 artefatos/Manifesto|Manifesto]]
