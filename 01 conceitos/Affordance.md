...
- [[Pinch to Zoom|Pinch to Zoom]] — O comportamento elástico e a física de pinça respondem imediatamente aos dedos do usuário, oferecendo uma affordance natural de escala/redução.
...
- **Definição**: Propriedades visuais ou físicas de um objeto que sugerem intuitivamente como utilizá-lo.
- **Artefatos chave explicados**: [[Pinch to Zoom|Pinch to Zoom]], [[Slide to Unlock|Slide to Unlock]], [[Post-it|Post-it]]
