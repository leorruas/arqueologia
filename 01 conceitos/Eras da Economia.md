...
1. **Era da Produção** (*"O desafio é fabricar"*): Focada na Revolução Industrial, ganho de escala e fabricação mecânica em massa. A principal barreira de design era a transformação da matéria. (Ex: Ford Model T, cadeiras de madeira de curvatura a vapor Thonet).
...
- **Definição**: Framework que divide a evolução do design em três momentos focados nos gargalos de fabricação (Produção), logística (Acesso) e seleção de dados (Decisão).
- **Artefatos chave explicados**: [[03 artefatos/Controle Remoto|Controle Remoto]], [[03 artefatos/Infinite Scroll|Infinite Scroll]]
