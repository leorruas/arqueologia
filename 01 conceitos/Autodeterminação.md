...
- [[03 artefatos/Visão|Visão]] — Aplicação na estruturação de autonomia ou foco de intenção de equipe.
- [[03 artefatos/Princípio|Princípio]] — Aplicação na estruturação de autonomia ou foco de intenção de equipe.
- [[03 artefatos/Retrospectiva|Retrospectiva]] — Aplicação na estruturação de autonomia ou foco de intenção de equipe.
...
- **Definição**: Princípio que postula que a motivação sustentável humana surge quando três necessidades psicológicas essenciais são aten...
- **Artefatos chave explicados**: [[03 artefatos/Visão|Visão]], [[03 artefatos/Princípio|Princípio]], [[03 artefatos/Retrospectiva|Retrospectiva]], [[03 artefatos/Jobs to Be Done|Jobs to Be Done]], [[03 artefatos/Workshop|Workshop]]
