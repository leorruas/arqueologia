...
- [[03 artefatos/Atalhos de Teclado|Atalhos de Teclado]] — Reduzem o custo de repetir ações de comando recorrentes (como copiar e colar), traduzindo uma busca em menus ou digitação de comandos longos em uma combinação instantânea de teclas físicas.
...
- **Definição**: Princípio que estuda a redução e condensação do esforço físico e mental exigido para repetir comportamentos recorrentes, consolidando múltiplos passos operacionais.
- **Artefatos chave explicados**: [[03 artefatos/Atalhos de Teclado|Atalhos de Teclado]], [[03 artefatos/Pull to Refresh|Pull to Refresh]], [[03 artefatos/Carrinho de Compras|Carrinho de Compras]]
