...
- [[Pinch to Zoom|Pinch to Zoom]] — Permite alterar o tamanho de uma imagem simulando a física de esticar ou comprimir um objeto flexível de borracha com dois dedos.
...
- **Definição**: Modelo de interação em que o usuário manipula objetos de interface como se fossem entidades físicas em tempo real.
- **Artefatos chave explicados**: [[Pinch to Zoom|Pinch to Zoom]], [[Slide to Unlock|Slide to Unlock]], [[Pull to Refresh|Pull to Refresh]]
