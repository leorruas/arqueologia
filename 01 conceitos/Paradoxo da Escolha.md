...
- [[03 artefatos/Controle Remoto|Controle Remoto]] — Reduziu drasticamente o custo físico de mudar de canal. O aumento súbito na oferta de canais, somado à facilidade de zapping, gerou uma exploração contínua e a incapacidade de manter a atenção focada em um único canal.
...
- **Definição**: Teoria que demonstra que a oferta maciça de opções e a facilidade de acessá-las geram paralisia decisória e insatisfação posterior.
