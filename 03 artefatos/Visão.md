...
- *On Becoming a Leader* por Warren Bennis
...
- **Relação de poder**: Pode aumentar autonomia ou ser usada apenas como discurso simbólico sem alterar a distribuição real das decisões.
- **Mundo antes da inovação**: Dependência de comandos rígidos e hierarquia excessiva.
- **A ideia que mudou tudo**: Estabilizar a direção futura (porquê) e deixar a forma aberta (como).
- **Comportamento aproveitado**: A tendência humana de organizar ações em torno de objetivos compartilhados.
- **Comportamento criado**: Decisões descentralizadas coerentes.
- **Por que funcionou**: Permitiu que indivíduos resolvessem problemas contextualizados respeitando uma diretriz comum.
- **Consequências inesperadas**: Organizações adotando visões puramente cosméticas.
...
- **Perguntas em aberto**: Como evitar a degeneração da Visão em slogan puramente corporativo?
