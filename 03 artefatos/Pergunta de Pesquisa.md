...
- **Período aproximado**: Universidades modernas (séculos XIX e XX).
- **Pessoas ou equipes envolvidas**: Não aplicável
- **Produto onde apareceu**: Não especificado
- **Problema original**: Como manter uma investigação coerente durante anos.
- **Hipótese sobre a natureza humana**: Não especificado
- **Relação de poder**: Não especificado
- **Mundo antes da inovação**: Investigações sem foco, que acumulavam fatos sem conseguir integrá-los em teorias úteis.
- **A ideia que mudou tudo**: Começar a pesquisa definindo com precisão qual lacuna de conhecimento se deseja responder.
- **Comportamento aproveitado**: Não especificado
- **Comportamento criado**: Não especificado
- **Por que funcionou**: Reduziu o esforço de curadoria eliminando dados irrelevantes ao propósito.
- **Consequências inesperadas**: Perguntas de pesquisa excessivamente estreitas que não geram utilidade social.
...
- **Perguntas em aberto**: Como manter flexibilidade na pergunta de pesquisa diante de descobertas inesperadas no campo?
