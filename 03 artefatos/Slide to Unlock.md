...
- **Ano aproximado**: 2007
- **Pessoas ou equipes envolvidas**: Equipe de design de interface e engenharia da [[empresas/Apple|Apple]]
- **Produto onde apareceu**: iPhone (1st generation)
- **Problema que resolvia**: Desbloqueio e toques acidentais na tela sensível ao toque enquanto o aparelho estava no bolso
- **Comportamento aproveitado**: O gesto físico e mecânico de abrir uma trava ou deslizar uma trava de ferrolho
- **Comportamento criado**: O hábito sensorial e gestual de "abrir" o telefone com um deslizar de polegar
- **Impacto histórico**: Consagrou a manipulação direta e o esqueuomorfismo nas interfaces móveis digitais no lançamento da computação móvel moderna
- **Conceitos relacionados**: [[01 conceitos/Manipulacao Direta|Manipulação Direta]], [[01 conceitos/Esqueuomorfismo|Esqueuomorfismo]], [[01 conceitos/Affordance|Affordance]], [[02 variaveis/Atrito Decisorio|Atrito Decisório]]
- **Artefatos relacionados para estudos futuros**: [[03 artefatos/Pinch to Zoom|Pinch to Zoom]]
