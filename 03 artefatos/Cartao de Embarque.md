...
- **Pessoas ou equipes envolvidas**: Desenvolvedores e designers das linhas aéreas comerciais da IATA
- **Produto onde apareceu**: Sistemas de bilhetagem aérea integrada
- **Problema que resolvia**: A lentidão e a falta de coordenação no controle de passageiros de massa antes do voo
- **Comportamento aproveitado**: O hábito humano de portar e apresentar documentos de identificação para obter passagem
- **Comportamento criado**: O ritual de transitar por portões aeroportuários escaneando um código de barras de forma autônoma
- **Impacto histórico**: Serviu como a interface de unificação logística e digitalização do tráfego aéreo internacional
- **Conceitos relacionados**: [[01 conceitos/Tecnologia de Acesso|Tecnologia de Acesso]], [[02 variaveis/Custo Transacional|Custo Transacional]], [[02 variaveis/Previsibilidade Visual|Previsibilidade Visual]]
- **Artefatos relacionados para estudos futuros**: QR Code de acesso, Apple Wallet, bilhete ferroviário clássico
