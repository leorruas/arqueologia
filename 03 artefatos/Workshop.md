...
- **Período aproximado**: Décadas de 1970 e 1980 no design participativo e desenvolvimento organizacional.
- **Pessoas ou equipes envolvidas**: Não aplicável
- **Produto onde apareceu**: Não especificado
- **Problema original**: Como produzir mudanças que as pessoas realmente adotem.
- **Hipótese sobre a natureza humana**: Participação aumenta comprometimento.
- **Relação de poder**: Pode redistribuir voz ou apenas simular participação para legitimar decisões já tomadas.
- **Mundo antes da inovação**: Decisões de processos tomadas isoladamente por gestores e posteriormente rejeitadas pelas equipes executoras.
- **A ideia que mudou tudo**: Envolver os executores na própria formulação e desenho da solução para gerar corresponsabilidade.
- **Comportamento aproveitado**: Não especificado
- **Comportamento criado**: Construção coletiva de decisões.
- **Por que funcionou**: Aproveitou a tendência humana de defender e adotar o que ajudou a criar.
- **Consequências inesperadas**: Dinâmicas cosméticas de facilitação ('teatro de design') usadas apenas para legitimar decisões predefinidas.
...
- **Perguntas em aberto**: Como garantir a sustentabilidade a longo prazo das decisões tomadas sob o entusiasmo momentâneo de um workshop?
