...
## A instituição precisa reconhecer um mesmo membro

[[autores/Paul Ricoeur|Paul Ricoeur]] distingue a identidade como mesmidade, *idem*, da ipseidade, *ipse*, ligada à constância de si através da mudança.[^3] O crachá não foi projetado para resolver esse problema filosófico, mas a distinção ajuda a perceber o tipo de identidade que uma instituição precisa tornar operável.

Para permitir entrada, localizar um vínculo ou aplicar uma permissão, a organização não precisa conhecer a história completa da pessoa. Precisa reconhecer **a mesma entidade institucional** entre encontros diferentes. Fotografia, nome, matrícula, função e número são escolhidos porque oferecem sinais relativamente estáveis que podem ser comparados.

Isso significa que o crachá não representa “quem a pessoa é” em sentido amplo. Ele representa aquilo que a instituição precisa saber para tratá-la de determinada maneira. Uma pessoa pode mudar de opinião, projeto, relação ou trajetória e continuar usando a mesma matrícula. Pode também continuar sendo a mesma pessoa e, ao mudar de vínculo, receber outro crachá e outras permissões.

O artefato torna visível uma operação comum aos sistemas: **transformar identidade em um conjunto mínimo de atributos relevantes para uma decisão**.

A comparação com [[03 artefatos/Portfólio|portfólio]] deixa a diferença clara. O portfólio tenta construir uma narrativa sobre quem alguém se tornou profissionalmente. O crachá comprime a pessoa numa identidade institucional suficiente para que terceiros saibam como reconhecê-la e o que ela pode fazer ali.
...
Ricoeur acrescenta um cuidado: verificabilidade institucional não deve ser confundida com identidade inteira. O sistema ganha eficiência justamente porque escolhe não representar grande parte da pessoa.
...
| **Autoria** | Distribuída |
| **Produto ou contexto** | Fábricas, repartições, escolas, empresas, hospitais, eventos e sistemas de controle de acesso |
| **Tipo(s) de design** | Relação disciplinar ainda não classificada. |
| **Empresas ou instituições relacionadas** | Organizações industriais e institucionais como contexto de popularização; nenhuma empresa única explica o artefato |
| **Problema original** | Identificar pertencimento e autorização em organizações grandes demais para reconhecimento pessoal |
| **Mundo antes** | Reconhecimento interpessoal, uniformes, listas, cartas e outras credenciais podiam sustentar pertencimento em contextos menores ou menos automatizados |
...
| **Leituras-chave** | [[00 índices/Livros Indicados|Oneself as Another]] como lente comparativa |
| **Princípio de design revelado** | Sistemas de escala tornam pertencimento operável selecionando poucos atributos estáveis de uma pessoa; a redução é funcional, mas nunca representa a identidade inteira |
...
[^3]: Ricoeur, Paul. *Soi-même comme un autre*. Paris: Seuil, 1990. Tradução inglesa: *Oneself as Another*, trad. Kathleen Blamey. Chicago: University of Chicago Press, 1992. Usado aqui como lente comparativa para distinguir mesmidade, ipseidade e formas reduzidas de identificação operacional.
