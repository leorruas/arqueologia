...
- **Pessoas ou equipes envolvidas**: Spencer Silver, Arthur Fry
- **Produto onde apareceu**: Post-it Notes (3M)
- **Problema que resolvia**: Fixar anotações temporárias e marcadores em superfícies de forma visivel sem causar danos materiais ou perder a mobilidade do item
- **Comportamento aproveitado**: O uso intuitivo do espaço físico como auxílio para a memória de curto prazo (memória distribuída)
- **Comportamento criado**: O mapeamento visual colaborativo de ideias e a interação fluida com a estrutura de pensamento em grupo
- **Impacto histórico**: Transformou ambientes de trabalho em interfaces de informação contextuais e pavimentou o caminho para a modelagem visual ágil de sistemas
- **Conceitos relacionados**: [[01 conceitos/Memoria Distribuida|Memória Distribuída]], [[01 conceitos/Autonomia da Atencao|Autonomia da Atenção]], [[01 conceitos/Affordance|Affordance]], [[02 variaveis/Reversibilidade|Reversibilidade]], [[02 variaveis/Permanencia|Permanência]]
- **Artefatos relacionados para estudos futuros**: Quadro Kanban físico, [[03 artefatos/Quadro Branco|Quadro Branco]]
