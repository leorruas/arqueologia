...
- **Período aproximado**: Década de 1960
- **Pessoas ou equipes envolvidas**: Fernando Corbató, pesquisadores do MIT
- **Produto onde apareceu**: CTSS (Compatible Time-Sharing System) no mainframe IBM 7090
- **Problema original**: Compartilhar o mesmo computador central mantendo a privacidade e a segurança dos dados de cada usuário.
- **Mundo antes da inovação**: O acesso aos computadores era sequencial e físico (cartões perfurados entregues a operadores), não existindo o conceito de conta pessoal digital protegida.
- **A ideia que mudou tudo**: Um limiar de software constituído por um nome de usuário e uma chave secreta (senha) que autoriza o acesso a um espaço isolado de dados.
- **Comportamento aproveitado**: O costume social antigo de usar chaves físicas para proteger ambientes privados e senhas para passar por sentinelas.
- **Comportamento criado**: O ato diário e automatizado de realizar login e logout em sistemas de informação.
- **Por que funcionou**: Resolveu o problema de escassez e custo de hardware da época através do compartilhamento lógico seguro, reduzindo o custo transacional de acesso remoto.
- **Consequências inesperadas**: Criação de um mercado massivo de cibercrimes focado no roubo de credenciais e a complexidade crescente de segurança imposta aos usuários comuns.
- **Legado**: Infraestrutura primária de controle, personalização e segurança de praticamente todos os serviços digitais e redes sociais existentes hoje.
- **Conceitos relacionados**: [[01 conceitos/Limiares|Limiares]], [[01 conceitos/Tecnologias de Delimitacao|Tecnologias de Delimitação]], Autenticação, Identidade
- **Família de ideias**: Artefatos de limiar e identidade
- **Parentes**: [[03 artefatos/Tela de Login|Tela de Login]], [[03 artefatos/Crachá|Crachá]]
- **Hipótese central**: O acesso a recursos em ambientes digitais compartilhados deve depender da identidade lógica provada e não da presença física.
- **Princípio de design revelado**: O design de interfaces pode criar limiares simbólicos que se comportam psicologicamente como portas físicas.
- **Destino do artefato**: Altamente integrado, evoluindo para formatos passivos (biometria, chaves físicas como YubiKeys) para reduzir a fricção de digitação de senhas.
- **Perguntas em aberto**: Como projetar sistemas de autenticação seguros que não dependam da memória humana e que sejam inclusivos para pessoas com dificuldades cognitivas?
