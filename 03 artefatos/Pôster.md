...
- **Período aproximado**: Segunda metade do século XIX aos dias atuais
- **Pessoas ou equipes envolvidas**: Alois Senefelder, Jules Chéret, Henri de Toulouse-Lautrec, designers construtivistas e da Bauhaus
- **Produto onde apareceu**: Muros urbanos, fachadas, estações de trem, teatros, campanhas políticas e eventos culturais
- **Problema original**: A necessidade de emitir mensagens visuais de grande escala no espaço público sem depender da presença física contínua do emissor
- **Mundo antes da inovação**: Comunicação pública restrita a pregoeiros orais, avisos tipográficos institucionais em preto e branco e arquitetura estática
- **A ideia que mudou tudo**: Unificar imagem colorida e tipografia expressiva em uma superfície impressa portátil que transforma qualquer parede urbana em meio de comunicação autônomo
- **Comportamento aproveitado**: Escaneamento visual periférico, orientação por contraste, atração por rostos e escala, e antecipação imaginativa
- **Comportamento criado**: O hábito urbano de ler superfícies verticais, buscar informações de eventos nas paredes e usar cartazes em espaços privados como sinalizadores de identidade pessoal
- **Por que funcionou**: Reduz a complexidade da mensagem a poucas formas e cores de grande impacto, capturando o olho do pedestre antes mesmo que ele decida prestar atenção
- **Consequências inesperadas**: Poluição visual urbana, efemeridade e acúmulo de camadas de papéis rasgados nas paredes, e a apropriação do formato por regimes totalitários para propaganda intensiva
- **Legado**: Serviu como matriz teórica e prática para a publicidade moderna, para a diagramação de capas e para as interfaces digitais de alta disputa de atenção
- **Conceitos relacionados**: [[01 conceitos/Peles Temporarias da Arquitetura|Peles Temporárias da Arquitetura]], [[01 conceitos/Limiares|Limiares]], [[01 conceitos/Economia da Atencao|Economia da Atenção]], [[02 variaveis/Atencao|Atenção]], [[02 variaveis/Previsibilidade Visual|Previsibilidade Visual]]
- **Família de ideias**: Peles temporárias da arquitetura / Dispositivos de enquadramento público
- **Parentes**: [[03 artefatos/Hero Section|Hero Section]], [[03 artefatos/Grid|Grid]], [[03 artefatos/Fila|Fila]], [[03 artefatos/Tapete|Tapete]], outdoor, mural, placa de sinalização, banner digital, thumbnail, post social
- **Hipótese central**: O pôster não vende diretamente um evento ou produto, mas diagrama uma sensação e fabrica uma expectativa futura na mente do observador em movimento
- **Princípio de design revelado**: Alterar a camada de interpretação simbólica sobre uma estrutura física estável transforma o uso e a percepção do espaço sem necessidade de reconstruí-lo
- **Perguntas em aberto**: Como a migração da comunicação de massa da rua aberta (pôster) para feeds digitais algorítmicos privados afeta a coesão da memória coletiva da cidade?
