...
- **Relação de poder**: Pode aumentar autonomia das equipes ou se transformar em painel de vigilância.
- **Mundo antes da inovação**: Equipes sobrecarregadas por demandas invisíveis acumuladas sem limites claros de capacidade.
- **A ideia que mudou tudo**: Tornar o fluxo visível para permitir a autorregulação coletiva.
- **Comportamento aproveitado**: Não especificado
- **Comportamento criado**: Gestão visual.
- **Por que funcionou**: Aproveitou a cognição visual humana para gerenciar limites operacionais de trabalho.
- **Consequências inesperadas**: Transformação do Kanban digital em painel de microvigilância de tempo de entrega.
...
- **Perguntas em aberto**: Como equilibrar a flexibilidade criativa de projetos com as restrições rígidas de raias de Kanban?
