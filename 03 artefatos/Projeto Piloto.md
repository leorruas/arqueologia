...
- **Período aproximado**: Década de 1950 a 1970
- **Pessoas ou equipes envolvidas**: Sem inventor único
- **Produto onde apareceu**: Plantas piloto industriais, estudos científicos e programas de políticas públicas
- **Problema original**: Mudar sem colocar tudo em risco
- **Mundo antes da inovação**: Mudanças organizacionais eram binárias: ou se mudava tudo de uma vez (alto risco) ou não se mudava nada.
- **A ideia que mudou tudo**: Criar um estado intermediário reversível de experimentação ("você ainda não mudou de vez, está apenas testando").
- **Comportamento aproveitado**: As pessoas aceitam melhor mudanças percebidas como temporárias, reversíveis e de baixo risco.
- **Comportamento criado**: Experimentar antes de decidir, validar hipóteses em pequena escala e institucionalizar o erro controlado.
- **Por que funcionou**: Reduziu drasticamente o custo psicológico e material do erro, além de diminuir a resistência e o atrito decisório das equipes.
- **Consequências inesperadas**: Pilotos que funcionam perfeitamente no ambiente protegido mas falham ao serem replicados na escala real da organização.
- **Legado**: Base de metodologias modernas de inovação, como Design Thinking, Lean Startup, Agile e desenvolvimento de software (testes A/B, feature flags).
- **Conceitos relacionados**: [[02 variaveis/Reversibilidade|Reversibilidade]], [[02 variaveis/Atrito Decisorio|Atrito Decisório]], [[02 variaveis/Custo do Erro|Custo do Erro]], [[02 variaveis/Friccao|Fricção]]
- **Família de ideias**: Artefatos de simulação
- **Parentes**: [[03 artefatos/Carrinho de Compras|Carrinho de Compras]], [[03 artefatos/Checklist|Checklist]]
- **Hipótese central**: O projeto piloto inventou a reversibilidade organizacional, permitindo que a inovação dependa de experimentação empírica e não de coragem política.
- **Princípio de design revelado**: O futuro pode ser explorado sem ser adotado imediatamente.
- **Destino do artefato**: Altamente integrado e onipresente em práticas corporativas, científicas e tecnológicas modernas.
- **Perguntas em aberto**: Como evitar que pilotos virem desculpas para protelar decisões definitivas ou ocultar falhas estruturais?
