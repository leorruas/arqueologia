...
- **Período aproximado**: Produto digital e estratégia, anos 2000.
- **Pessoas ou equipes envolvidas**: Não aplicável
- **Produto onde apareceu**: Não especificado
- **Problema original**: Como evitar que equipes otimizem métricas locais enquanto perdem o objetivo maior.
- **Hipótese sobre a natureza humana**: Não especificado
- **Relação de poder**: Não especificado
- **Mundo antes da inovação**: Equipes de tecnologia construindo dezenas de funcionalidades sem clareza sobre qual valor de uso estavam maximizando.
- **A ideia que mudou tudo**: Definir uma métrica que captura simultaneamente o valor para o cliente e o crescimento do negócio.
- **Comportamento aproveitado**: Não especificado
- **Comportamento criado**: Não especificado
- **Por que funcionou**: Aproveitou a necessidade de clareza visual de métricas para coordenar equipes autônomas.
- **Consequências inesperadas**: Manipulação ('gaming the metric') da North Star em detrimento da experiência do usuário real.
...
- **Perguntas em aberto**: Como evitar o enrijecimento de uma North Star quando o mercado ou o comportamento do usuário mudam bruscamente?
