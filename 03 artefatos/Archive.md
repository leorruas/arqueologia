...
- **Ano aproximado**: 2004
- **Pessoas ou equipes envolvidas**: Paul Buchheit e equipe original do Gmail
- **Produto onde apareceu**: Gmail
- **Problema que resolvia**: A carga cognitiva de decidir onde armazenar cada mensagem recebida em estruturas de pastas complexas
- **Comportamento aproveitado**: O ato mental de empurrar a papelada para fora da mesa de trabalho para focar no presente ("tirar da frente")
- **Comportamento criado**: O arquivamento rápido de itens com a expectation de recuperá-los de forma passiva através de sistemas de busca
- **Impacto histórico**: Inaugurou o paradigma de recuperação passiva por busca, desestimulando a categorização manual rigorosa e influenciando o design de sistemas de arquivos contemporâneos
- **Conceitos relacionados**: [[01 conceitos/Autonomia da Atencao|Autonomia da Atenção]], [[01 conceitos/Tecnologia de Acesso|Tecnologia de Acesso]], [[02 variaveis/Atrito Decisorio|Atrito Decisório]], [[02 variaveis/Custo de Busca|Custo de Busca]], [[02 variaveis/Atencao|Atenção]]
- **Artefatos relacionados para estudos futuros**: [[03 artefatos/Undo Send|Undo Send]]
