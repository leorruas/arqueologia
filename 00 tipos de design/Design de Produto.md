...
O [[03 artefatos/Mochila|Mochila]] acrescenta ergonomia de transporte; a [[03 artefatos/Carteira|Carteira]], concentração portátil de valor e credenciais; a [[03 artefatos/Garrafa de Agua|Garrafa de água]], uma reserva material capaz de tornar um recurso disponível longe de sua fonte; e o [[03 artefatos/Vaso de Plantas|Vaso de plantas]], uma pequena infraestrutura que permite deslocar parte das condições de cultivo junto com a planta. Nenhum desses objetos precisou esperar a existência de um “designer de produto” para incorporar hipóteses sobre alcance, mobilidade, privacidade, cuidado ou repetição.
...
Mas reduzir esforço numa dimensão pode criar dependência em outra. A mochila libera as mãos e transfere peso para costas e ombros. A garrafa amplia autonomia e cria a tarefa de abastecer e transportar o recipiente. O [[03 artefatos/Vaso de Plantas|vaso de plantas]] permite deslocar uma planta para fora do solo contínuo, mas transfere para alguém tarefas de rega, adubação e manutenção antes parcialmente distribuídas pelo ambiente. Esse tipo de troca ajuda a tornar visível [[01 conceitos/Portabilizacao de contexto|portabilização de contexto]]: para libertar algo de um lugar, o produto frequentemente precisa carregar, reconstruir ou substituir parte das condições que aquele lugar fornecia. O controle remoto reduz deslocamento e torna a mudança de canal praticamente sem custo. A carteira concentra documentos e valor, mas aumenta o impacto de perdê-los todos de uma vez.
